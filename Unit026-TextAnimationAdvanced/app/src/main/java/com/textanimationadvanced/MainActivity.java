package com.textanimationadvanced;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnRotate.setOnClickListener(btnRotateOnClick);mBtnScale.setOnClickListener(btnScaleOnClick);
    ...
    private View.OnClickListener btnChangeColorOnClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            final int iBackColor =
                    ((ColorDrawable)(mLinLayRoot.getBackground())).getColor();
            ...
            animScreenBackColor.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(){
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    int val = (Integer)animation.getAnimatedValue();
                    mLinLayRoot.setBackgroundColor(
                            iBackColor & 0xFF00FFFF | val << 16);
                }
            });
        }
    };
